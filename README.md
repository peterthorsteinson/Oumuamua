...
What is an online game? That term is in the process of being redefined. The new online metaverse will not just be traditional multiplayer games like Eve Online and Fortnite. In the new online metaverse, everything will be a game and everyone will be a player. The majority of the world population will be engaged in playing this metaverse game, generally without realizing or caring about its intrinsic game nature. The economic engines in this game playing metaverse will be decentralized, zero-trust, game-theoretic, cryptocurrency-based virtual and augmented realities. Traditional gaming innovations gave us VR (Virtual Reality, where all entities are in-game objects) and AR (Augmented Reality, where entities are extended and superimposed onto real-world environments). In a similar way, metaverse innovations will generate VE (Virtual Economy, where all financial transactions are in-game tokens) and AE (Augmented Economy, where financial transactions are extended and superimposed onto real-world cryptocurrency blockchains).

### From Web 2.0 to Web 3.0

One could argue that, today, Facebook is actually already a multiplayer online role-playing platform. One where participants freely and naively release all ownership of their own valuable private data and content contribution. In a similar way, the inevitable online metaverse will become everything to everyone. A source of income, and a source of entertainment. A source of social interaction, and a source of education. It will encompass all human economic activity. But it will be decentralized and self-sovereign, which would be a major improvement over legacy Facebook. The big difference would be that participants will directly and fairly share in the wealth generation of the new multiverse economy, and they will have fine-grained self-sovereign control over their own personal data and content. Facebook and other centralized Web 2.0 titans, such as YouTube have gradually de-monetized and de-platformed many alternative voices. Often these are voices that threaten business and political interests of Facebook, YouTube, etc. Censorship, which has historically been a problem of repressive totalitarian governments, is now often a corporate problem, which plagues modern societies that have been traditionally open and democratic. The risk of abuse of these corporate powers over public opinion and behavior are abundant. The new metaverse will solve many of these problems and even the playing field.

The new Web 3.0 online metaverse economy will involve "work" that is so different from what we mean by that word today that "work" will be unrecognizable, as we currently know it. Robotics and AI will assume the traditional role of productive labor, and the new human "work" will be indistinguishable from social network play. Meanwhile, automated systems will operate fully autonomous robotics that handle the entire industrial process at zero cost, from the harvest and transport of natural and agricultural resources, to designing and implementing all processing and manufacturing, down to the last mile of distribution and supply chain maintenance. The result is that the cost of living tends toward zero. Thus, both the opportunity for employment and the need for employment evaporate. That's the future of all manufacturing and agricultural labor. Ditto for every other labor sector. No humans required. Virtually all human labor, whether it be blue blue collar or white blue collar, skilled or unskilled, services or sales, or medical or engineering, it will all be automated. Social networking will be all that remains.

### OpenAI GPT-3: Enormous Opportunity and Enormous Threat

OpenAI GPT-3 (Generative Pretrained Transformer) represents a huge recent step in AI development. It is based on meta-learning which involves learning about its own learning. Even in its current infancy, it is showing signs of amazing machine learning power. This is the sort of technology which will eventually totally replace all human cognitive capabilities. It represents an enormous opportunity and an enormous threat. It must be handled carefully.

The descendants of GPT-3 and similar projects will eventually automate all human employment potential. GPT-3, and similar AI developments, will be used to further research subsequent AI innovations, resulting in an exponential rate of progress. Today, GPT-3 is the writing on the wall. It will be the end of human lawyers, doctor, engineers, teachers, mathematicians, statisticians, and scientists. STEM education is a futile effort to pursue careers in this new environment, at least in the long term. It is time to rethink everything we ever thought we knew about how human economic activity operates. And we have to sort this out ASAP. Online gaming, in its most general interpretation, becomes very attractive in this new economic regime. Perhaps the only "game" in town.
...
## A Game Example: The ʻOumuamua Game
