...
One could argue that, today, Facebook is actually already a multiplayer online role-playing platform. One where participants freely and naively release all ownership of their own valuable private data and content contribution. In a similar way, the inevitable online metaverse will become everything to everyone. A source of income, and a source of entertainment. A source of social interaction, and a source of education. It will encompass all human economic activity. But it will be decentralized and self-sovereign, which would be a major improvement over legacy Facebook. The big difference would be that participants will directly and fairly share in the wealth generation of the new multiverse economy, and they will have fine-grained self-sovereign control over their own personal data and content. Facebook and other centralized Web 2.0 titans, such as YouTube have gradually de-monetized and de-platformed many alternative voices. Often these are voices that threaten Facebook's business and political interests. Censorship, which has historically been a problem of repressive totalitarian governments, is now mostly a corporate problem, which now plagues societies in what have been considered traditionally open and democratic political contexts. The risk of abuse of these corporate powers over public opinion and behavior are abundant. The new metaverse will solve many of these problems and even the playing field.

The new Web 3.0 online metaverse economy will involve "work" that is so different from what we mean by that word today that "work" will be unrecognizable, as we currently know it. Robotics and AI will assume the traditional role of productive labor, and the new human "work" will be indistinguishable from social network play. Meanwhile, automated systems will operate fully autonomous robotic systems that handle the entire industrial process, from harvesting and transport of natural and agricultural resources, to designing and implementing all processing and manufacturing, down to the last mile of distribution and supply chain maintenance. That's the future of all manufacturing and agricultural labor. Ditto for every other labor sector. No humans need apply. Virtually all human labor, whether it be blue color or white color, skilled or unskilled, services, sales, or medical, and even academic, it will all be automated. Social networking will be all that remains.
